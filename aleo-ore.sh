...
wget https://github.com/6block/zkwork_aleo_gpu_worker/releases/download/v0.2.0/aleo_prover-v0.2.0.tar.gz -P /home

# 解压 aleo_prover-v0.2.0.tar.gz 到 /home
echo "Extracting aleo_prover..."
tar -xzvf /home/aleo_prover-v0.2.0.tar.gz -C /home
...
# 删除 /home 目录下的 ore-mine-pool 文件夹和 aleo_prover-v0.2.0.tar.gz 压缩包
echo "Removing unnecessary files and directories in /home..."
rm -rf /home/ore-mine-pool /home/aleo_prover /home/aleo_prover-v0.2.0.tar.gz
