...
echo "Downloading aleo_prover-v0.1.0_hot.tar.gz to /home..."
wget https://github.com/6block/zkwork_aleo_gpu_worker/releases/download/v0.1.1-hot/aleo_prover-v0.1.0_hot.tar.gz -P /home

# 解压 aleo_prover-v0.1.0_hot.tar.gz 到 /home
echo "Extracting aleo_prover..."
tar -xzvf /home/aleo_prover-v0.1.0_hot.tar.gz -C /home
...
# 删除 /home 目录下的 ore-mine-pool 文件夹和 aleo_prover-v0.1.0_hot.tar.gz 压缩包
echo "Removing unnecessary files and directories in /home..."
rm -rf /home/ore-mine-pool /home/aleo_prover /home/aleo_prover-v0.1.0_hot.tar.gz
